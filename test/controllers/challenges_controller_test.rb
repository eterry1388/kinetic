...
class ChallengesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create challenge" do
    assert_difference("Challenge.count") do
      post challenges_url, params: { challenge: { description: @challenge.description, title: @challenge.title } }
    end
  ...
  test "should update challenge" do
    patch challenge_url(@challenge), params: { challenge: { description: @challenge.description, title: @challenge.title } }
